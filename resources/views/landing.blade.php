...
<head>
	...
	<link rel="stylesheet" type="text/css" href="icomon/icomoon.css">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="right-element">
							...
							<a href="#" class="cart for-buy"><i class="icon icon-clipboard"></i><span>keranjang :( 0
									)</span></a>
		...
		<header id="header">
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-md-2">
						<div class="main-logo">
							<a href="index.html"><img src="https://ipusnas.id/images/logo.png" alt="logo"></a>
						</div>
								...
								<ul class="menu-list">
									...
									<li class="menu-item has-sub">
										...
										<ul>
											...
											<li><a href="about.html">About <span class="badge bg-dark"></span></a></li>
											<li><a href="styles.html">Styles <span class="badge bg-dark"></span></a></li>
											<li><a href="blog.html">Blog <span class="badge bg-dark"></span></a></li>
											<li><a href="single-post.html">Post Single <span class="badge bg-dark"></span></a></li>
											<li><a href="shop.html">Our Store <span class="badge bg-dark"></span></a></li>
											<li><a href="single-product.html">Product Single <span class="badge bg-dark"></span></a></li>
											<li><a href="contact.html">Contact <span class="badge bg-dark"></span></a></li>
											<li><a href="thank-you.html">Thank You <span class="badge bg-dark"></span></a></li>
										</ul>
									...
									<li class="menu-item"><a href="login" class="nav-link btn btn-outline-dark rounded-pill m-0" target="_blank">Login</a></li>
								</ul>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="tabs">
						...
						<li data-tab-target="#business" class="tab">Bisnis</li>
						<li data-tab-target="#technology" class="tab">Teknologi</li>
						<li data-tab-target="#romantic" class="tab">Romantis</li>
								...
								<div class="col-md-3">
									<div class="product-item">
										...
										<figcaption>
											<h3>Simple way of piece life</h3>
											<span>Armor Ramsey</span>
											<div class="item-price">Rp.60.000</div>
										</figcaption>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="product-item">
										...
										<figcaption>
											<h3>Peaceful Enlightment</h3>
											<span>Marmik Lama</span>
											<div class="item-price">Rp.45.0000</div>
										</figcaption>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="product-item">
										...
										<figcaption>
											<h3>Great travel at desert</h3>
											<span>Sanchit Howdy</span>
											<div class="item-price">Rp.40.500</div>
										</figcaption>
									</div>
								</div>
						...
						<div class="grid product-grid">
							<div class="product-item">
								...
								<figcaption>
									...
									<div class="item-price">
										<span class="prev-price">Rp.50.000</span>Rp.40.000
									</div>
								</div>
							</figcaption>
							...
							<div class="product-item">
								...
								<figcaption>
									...
									<span>Sanchit Howdy</span>
									<div class="item-price">
										<span class="prev-price">Rp.30.000</span>Rp.28.000
									</div>
								</div>
							</figcaption>
							...
							<div class="product-item">
								...
								<figcaption>
									...
									<span>Arthur Doyle</span>
									<div class="item-price">
										<span class="prev-price">Rp.35.000</span>Rp.25.000
									</div>
								</div>
							</figcaption>
							...
							<div class="product-item">
								...
								<figcaption>
									...
									<span>Klien Marry</span>
									<div class="item-price">
										<span class="prev-price">Rp.35.000</span>Rp.30.000
									</div>
								</div>
							</figcaption>
				...
				<div class="col-md-4">
					...
					<div class="footer-item">
						<div class="company-brand">
							<img src="https://ipusnas.id/images/logo.png" alt="logo" class="footer-logo">
				...
				<div class="col-md-12">
					...
					<div class="copyright">
						<div class="row">
							...
							<div class="col-md-6">
								<p>© 2023 All rights reserved. by andre dafa tety qeysya nisa<a
										href="https://www.templatesjungle.com/" target="_blank">iPusnas</a></p>
							</div>
